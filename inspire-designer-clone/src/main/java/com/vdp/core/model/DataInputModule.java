...
public class DataInputModule implements InspireModule {
    ...
    @Override
    public List<Port> getInputPorts() { return new ArrayList<>(); } // No tiene entradas[cite: 1]
    ...
    public void execute(ExecutionContext context) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(inputFilePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                // 2. Separar por comas (fieldSeparators), ignorando las que estan entre comillas (textQualifiers)[cite: 2]
                ...
                // 4. Determinar si es cabecera o registro[cite: 2]
                if (useFirstRecordAsFieldNames && isFirstDataRow) {
                    System.out.println("=> ESQUEMA DETECTADO: " + Arrays.toString(values));
                    isFirstDataRow = false;
                } else {
                    System.out.println("Registro procesado: " + Arrays.toString(values));
                }
            }
        } catch (Exception e) {
